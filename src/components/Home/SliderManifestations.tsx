...
const SliderManifestations = () => {
  return (
    <div className="w-full h-[60vh] lg:h-[90vh] lg:p-6 top-20 relative overflow-hidden">
      <h1 className="text-center text-2xl p-2 lg:p-0 lg:text-4xl font-bold text-blue-900 lg:mb-6">
      ...
      >
        {manifestations.map((event) => (
          ...
          >
            ...
            />
            <div className="absolute bottom-20 lg:bottom-10 text-center w-full bg-gradient-to-t from-black/70 to-transparent p-4 text-white lg:rounded-b-3xl">
              <h3 className="text-3xl lg:text-5xl font-bold text-blue-200 drop-shadow-sm mb-2">
                {event.title}
              </h3>
